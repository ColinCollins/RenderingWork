...
function createCircle (pos, radius) {
    ...
    for (let i = 0; i < n; i++) {
        ...
        log(`Cos = ${cos} Sin = ${sin}`);
        let x = cos * radius % 1 > 0.5 ? Math.ceil(cos * radius + pos.x) : Math.floor(cos * radius + pos.x);
        let y = sin * radius % 1 > 0.5 ? Math.ceil(sin * radius + pos.y) : Math.floor(sin * radius + pos.y);
        ...
        log(`Cos = ${cos} Sin = ${sin}`);
        x = cos * radius % 1 > 0.5 ? Math.ceil(cos * radius + pos.x) : Math.floor(cos * radius + pos.x);
        y = sin * radius % 1 > 0.5 ? Math.ceil(sin * radius + pos.y) : Math.floor(sin * radius + pos.y);
